...
class VideoModel {
    ...
    public function _video_getflashinfo($link, $host) {
		...
		if('youku.com' == $host)
        {
            ...
            preg_match('/id\_(.+)\.html/', $link, $flashvar);
            ...
            //http://player.youku.com/player.php/Type/Folder/Fid//Ob//sid/XMTg3MTc5NTU0MA==/v.swf
            $flash_url = 'http://player.youku.com/player.php/Type/Folder/Fid//Ob//sid/'.$flashvar[1].'/v.swf';
        }
        elseif('ku6.com' == $host)
        {
        ...
        elseif('sina.com.cn' == $host)
        {
            ...
            preg_match("/pic\:[ ]*\'(.*?)\'/i",$content,$img);
            preg_match("/<title>(.*?)<\/title>/i",$content,$title);
            //http://video.sina.com.cn/share/video/202424757.swf
            //$flash_url = 'http://you.video.sina.com.cn/api/sinawebApi/outplayrefer.php/vid='.$flashvar[1].'/s.swf';
            /*2016-12-20 修改*/
            $flash_url = 'http://video.sina.com.cn/share/video/'.$flashvar[1].'.swf';
        }
