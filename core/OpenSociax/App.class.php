...
class App
{
    ...
    static public function execApp() {
        ...
        //防止CSRF   
        //修改允许android 访问头像 by frsun 2013.11.19 
//  2016-11-2 注释
//        if(strtolower($_REQUEST['act'])!='dosaveavatar' & strtolower($_REQUEST['from'])!='ew' ){
...
//         model('Schedule')->run();
    ...
    static public function execWidget() {
        //防止CSRF
        //允许android 发表图片说说 yangli4
//  2016-11-2 注释
//        if(strtolower($_REQUEST['act'])!='save'){
//            if(strtoupper($_SERVER['REQUEST_METHOD'])=='POST' && stripos($_SERVER['HTTP_REFERER'], SITE_URL)!==0 && $_SERVER['HTTP_USER_AGENT'] !== 'Shockwave Flash') {
//                die('illegal request.');
//            }
//        }
    ...
    static public function appException($e) {
    	Log::write('appException ' . $e->__toString(), Log::ERR);
