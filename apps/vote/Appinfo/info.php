...
return array(
	...
	'NAME'						=> '网络调研',
	// 应用简介 [必填]
	'DESCRIPTION'				=> '想分享你的网络调研给你的好友么，快来发起网络调研吧',
	// 托管类型 [必填]（0:本地应用，1:远程应用）
	'HOST_TYPE'					=> '0',
	// 前台入口 [必填]（格式：Action/act）
	'APP_ENTRY'					=> 'Index/index',
	// 应用图标 [必填]
	'ICON_URL'					=> SITE_URL . '/apps/vote/Appinfo/icon_app.png',
	// 应用图标 [必填]
	'LARGE_ICON_URL'			=> SITE_URL . '/apps/vote/Appinfo/icon_app_large.png',
	// 版本号 [必填]
	'VERSION_NUMBER'			=> '33566',
	// 后台入口 [选填]
	'ADMIN_ENTRY'				=> 'vote/Admin/index',
