<?php
require_once APP_LIB_PATH.'/BBTModel/BookIndex.php';
require_once APP_LIB_PATH.'/BBTModel/ResourceType.php';
require_once APP_LIB_PATH.'/BBTModel/ResourceUsage.php';
