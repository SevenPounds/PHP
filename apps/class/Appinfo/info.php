...
return array(
	...
	// 后台入口 [选填]
	'ADMIN_ENTRY'				=> 'school/Admin/index',
	// 统计入口 [选填]（格式：Model/method）
	'STATISTICS_ENTRY'			=> 'SchoolStatistics/statistics',
	// 应用的主页 [选填]
	'HOMEPAGE_URL'				=> '',
	// 应用类型
	'CATEGORY'					=> '工具',
	...
	'AUTHOR_NAME'				=> 'iflytek',
	// 作者Email [必填]
	'AUTHOR_EMAIL'				=> 'chengcheng3@iflytek.com',
	// 作者主页 [选填]
	'AUTHOR_HOMEPAGE_URL'		=> '',
	// 贡献者姓名 [选填]
	'CONTRIBUTOR_NAMES'			=> 'chengcheng3',
);