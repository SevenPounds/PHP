...
return array(
	...
	'NAME'						=> '名师工作室',
	// 应用简介 [必填]
	'DESCRIPTION'				=> '创建名师工作室，展示名师成果。',
	// 托管类型 [必填]（0:本地应用，1:远程应用）
	'HOST_TYPE'					=> '0',
	// 前台入口 [必填]（格式：Action/act）
	'APP_ENTRY'					=> 'Index/index',
	// 应用图标 [必填]
	'ICON_URL'					=> SITE_URL . '/apps/msgroup/Appinfo/icon_app24.png',
	// 应用图标 [必填]
	'LARGE_ICON_URL'			=> SITE_URL . '/apps/msgroup/Appinfo/icon_app.png',
	// 版本号 [必填]
	'VERSION_NUMBER'			=> '1',
	// 后台入口 [选填]
	'ADMIN_ENTRY'				=> 'msgroup/Admin/index',
	...
	'AUTHOR_NAME'				=> 'yuliu2',
	// 作者Email [必填]
	'AUTHOR_EMAIL'				=> 'yuliu2@iflytek.com',
	// 作者主页 [选填]
	'AUTHOR_HOMEPAGE_URL'		=> '',
	// 贡献者姓名 [选填]
	'CONTRIBUTOR_NAMES'			=> '',
