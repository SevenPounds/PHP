...
class AttachAction extends Action{
	...
	public function ajaxUpload(){
        ...
        $conmment = $this->user['uname']."于".date("Y-m-d H:i:s",time())."在兴趣圈子上传了“".$data['name']."”附件";
        $logObj = $this->getLogObj(C("appType")["jyyy"]["code"],C("appId")["xqqz"]["code"],C("opType")["upload"]['code'],$data["attach_id"],C("location")["localServer"]["code"],"","",$data['name'],$this->mid,$this->user['login'],$this->user['uname'],$this->roleEnName,"",$conmment);
