...
$.fn.media.defaults.players = {
	...
	winmedia: {
		name:		  'winmedia',
		title:		  'Windows Media plugin',
		types:		  'asx,asf,avi,wma,wmv',
		mimetype:	  $.browser.mozilla && isFirefoxWMPPluginInstalled() ? 'application/x-ms-wmp' : 'application/x-mplayer2',
		pluginspage:  'http://www.interoperabilitybridges.com/windows-media-player-firefox-plugin-download',//http://www.microsoft.com/Windows/MediaPlayer/',
		autoplayAttr: 'autostart',
		oUrl:		  'url',
		ieAttrs: {
...
function generate(el, opts, player) {
	...
	if (player == 'iframe') {
		...
		// Alternate HTML
		a.push('<div><p><strong>'+o.title+' Required</strong></p><p>预览此文件需要 '+o.title+'<a href="'+o.pluginspage+'">点击下载</a>，重启浏览器即可</p></div>');
		a.push('</ob'+'ject'+'>');
	}
	 else {
